...
export function FeatureEntryPanel({ options, onSelect }: FeatureEntryPanelProps) {
  return (
    <section className="h-full">
      <p className="text-sm font-medium tracking-wide text-[#7b74a4]">工作台入口</p>
      <h1 className="mt-1 text-[30px] font-semibold leading-[1.2] tracking-tight text-[#2c2740] lg:text-[38px]">
        开始一次市场分析任务
      </h1>
      <p className="mt-2 max-w-[760px] text-sm text-[#655f84]">选择合适的分析模式后进入数据准备，流程与历史任务保持一致，仅优化视觉风格与信息可读性。</p>
