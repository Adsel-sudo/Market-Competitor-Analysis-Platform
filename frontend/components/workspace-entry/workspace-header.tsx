export function WorkspaceHeader() {
  return (
    <header className="flex h-[62px] w-full items-center justify-between border-b border-[#e6e1db] bg-[#ffffff] px-5 shadow-[0_4px_12px_rgba(80,62,118,0.06)] lg:px-8 xl:px-12">
      <div>
